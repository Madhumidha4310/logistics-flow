...
import { e as FiBell, f as FiSun, g as FiMoon, h as FiLogOut, F as FiTruck, i as FiGrid, j as FiPackage, k as FiUserCheck, l as FiUsers, m as FiMapPin, n as FiCreditCard, o as FiBarChart2, p as FiShield, q as FiSettings, a as FiUser } from "./_libs/react-icons.mjs";
import { u as useAuth, a as useTheme } from "./_ssr/router-DgeizMII.mjs";
...
function AppSidebar() {
  ...
  const renderGroup = (label, items) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
    !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { className: "text-sidebar-foreground/50 uppercase text-[10px] tracking-widest", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: isActive(item.url), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, className: "flex items-center gap-3", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", className: "flex items-center gap-2 px-2 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-lg bg-gradient-accent grid place-items-center text-white shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiTruck, { className: "size-4" }) }),
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm truncate", children: "Transport" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-sidebar-foreground/60 truncate", children: "Agencies Platform" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t border-sidebar-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 py-2 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-full bg-gradient-accent grid place-items-center text-white text-xs shrink-0", children: user?.email?.[0]?.toUpperCase() ?? "U" }),
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: user?.email }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-sidebar-foreground/60 truncate", children: "Signed in" })
      ] })
    ] }) })
  ] });
}
function AuthenticatedLayout() {
  ...
  if (loading || !user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-10 rounded-full border-2 border-accent border-t-transparent animate-spin" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex w-full bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 h-14 flex items-center gap-3 border-b border-border bg-background/80 backdrop-blur px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", "aria-label": "Notifications", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiBell, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: toggle, "aria-label": "Theme", children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(FiSun, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(FiMoon, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => {
          signOut();
          navigate({
            to: "/"
          });
        }, "aria-label": "Sign out", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiLogOut, {}) })
      ] }),
